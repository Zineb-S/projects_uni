...
/* components_modals.html.twig */
class __TwigTemplate_00c4c8d67dc5fd835e676c83eacffda1 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "components_modals.html.twig"));
...
<head>
  <meta charset=\"utf-8\">
    ...
    <title>Sunny Admin - Dashboard  Modals UI </title>
...
\t\t\t\t  <div>
\t\t\t\t\t  <button type=\"button\" class=\"btn btn-rounded btn-default\" data-toggle=\"modal\" data-target=\"#modal-default\">
\t\t\t\t\t\tLaunch Default Modal
\t\t\t\t\t  </button>              

\t\t\t\t\t  <button type=\"button\" class=\"btn btn-rounded btn-info\" data-toggle=\"modal\" data-target=\"#modal-info\">
\t\t\t\t\t\tLaunch Info Modal
\t\t\t\t\t  </button>

\t\t\t\t\t  <button type=\"button\" class=\"btn btn-rounded btn-primary\" data-toggle=\"modal\" data-target=\"#modal-primary\">
\t\t\t\t\t   Launch Primary Modal
\t\t\t\t\t  </button>

\t\t\t\t\t  <button type=\"button\" class=\"btn btn-rounded btn-danger\" data-toggle=\"modal\" data-target=\"#modal-danger\">
\t\t\t\t\t\tLaunch Danger Modal
\t\t\t\t\t  </button>

\t\t\t\t\t  <button type=\"button\" class=\"btn btn-rounded btn-warning\" data-toggle=\"modal\" data-target=\"#modal-warning\">
\t\t\t\t\t\tLaunch Warning Modal
\t\t\t\t\t  </button>

\t\t\t\t\t  <button type=\"button\" class=\"btn btn-rounded btn-success\" data-toggle=\"modal\" data-target=\"#modal-success\">
...
\t\t\t\t  <button type=\"button\" class=\"btn btn-rounded btn-info\" data-toggle=\"modal\" data-target=\"#modal-left\">
\t\t\t\t\tLaunch demo modal
\t\t\t\t  </button>
...
\t\t\t\t  <button type=\"button\" class=\"btn btn-rounded btn-info\" data-toggle=\"modal\" data-target=\"#myModal\">
\t\t\t\t\tMedium model
\t\t\t\t  </button>
\t\t\t\t</div>
\t\t\t  </div>
...
\t\t\t\t  <button type=\"button\" class=\"btn btn-rounded btn-info\" data-toggle=\"modal\" data-target=\".bs-example-modal-sm\">
\t\t\t\t\tSmall model
\t\t\t\t  </button>
\t\t\t\t</div>
\t\t\t  </div>
...
\t\t  <div class=\"modal-footer\">
\t\t\t<button type=\"button\" class=\"btn btn-rounded btn-danger\" data-dismiss=\"modal\">Close</button>
\t\t\t<button type=\"button\" class=\"btn btn-rounded btn-info float-right\">Save changes</button>
\t\t  </div>
\t\t</div>
\t\t<!-- /.modal-content -->
\t  </div>
...
";
    ...
    {
        return "components_modals.html.twig";
    }
...
", "components_modals.html.twig", "C:\\Users\\zselm\\FindMyWay\\templates\\components_modals.html.twig");
    }
}
