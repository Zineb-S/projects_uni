...
/* gallery.html.twig */
class __TwigTemplate_1f90096b1aeea88a586ca01d3f7fae66 extends Template
{
    private $source;
    private $macros = [];
...
<head>
  <meta charset=\"utf-8\">
    ...
    <title>Sunny Admin - Dashboard  Gallery </title>
...
\t\t\t\t\t<div class=\"btn-group\">
\t\t\t\t\t  <button class=\"btn btn-info btn-rounded\" id=\"filter-all\">All</button>
\t\t\t\t\t  <button class=\"btn btn-info btn-rounded\" id=\"filter-studio\">Studio</button>
\t\t\t\t\t  <button class=\"btn btn-info btn-rounded\" id=\"filter-landscape\">Landscapes</button>
\t\t\t\t\t</div>
\t\t\t\t</div>
\t\t\t  </div>
\t\t\t  <!-- Default box -->
...
\t<script src=\"js/vendors.min.js\"></script>
    <script src=\"../assets/icons/feather-icons/feather.min.js\"></script>\t<script type=\"text/javascript\" src=\"../assets/vendor_components/gallery/js/animated-masonry-gallery.js\"></script>
...
", "gallery.html.twig", "C:\\Users\\zselm\\FindMyWay\\templates\\gallery.html.twig");
    }
}
